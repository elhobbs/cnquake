...
entity_t	*CL_EntityNum (int num)
{
	...
	if (num >= cl.num_entities)
	{
		...
		n = num - cl.num_entities + 1;
		ent = (entity_t *)Hunk_AllocName(sizeof(entity_t)*n,"entity");
		while (cl.num_entities<=num)
		{
//			ent = (entity_t *)Hunk_AllocName(sizeof(entity_t),"entity");
			ent->colormap = vid.colormap;
			cl_entities[cl.num_entities] = ent;
			cl.num_entities++;
			ent++;
		}
	}
...
void CL_ParseServerInfo (void)
{
	...
	//model_precache = (char *)Hunk_TempAlloc((MAX_MODELS+MAX_SOUNDS)*MAX_QPATH);
