...
cvar_t	v_iyaw_level = {"v_iyaw_level", "0.8", false};
cvar_t	v_iroll_level = {"v_iroll_level", "0.8", false};
cvar_t	v_ipitch_level = {"v_ipitch_level", "1.3", false};
...
void V_CalcViewRoll (void)
{
	...
	side = V_CalcRoll (ent->angles, cl.velocity);
