...
typedef struct FNET_COMP_PACKED_STRUCT
{
 ...
 ***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct  FNET_COMP_PACKED_STRUCT fnet_ip6_options_header
{
 ...
 ***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct  FNET_COMP_PACKED_STRUCT fnet_ip6_option_header
{
 ...
 ***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct  FNET_COMP_PACKED_STRUCT fnet_ip6_routing_header
{
    unsigned char   next_header     FNET_COMP_PACKED;   /* 8-bit selector. Identifies the type of header
                                                         * immediately following the Options
                                                         * header. */
 ...
 ***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct  FNET_COMP_PACKED_STRUCT fnet_ip6_fragment_header
{
 ...
 ******************************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct  FNET_COMP_PACKED_STRUCT fnet_ip6_frag_header
{
 ...
 ******************************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct  FNET_COMP_PACKED_STRUCT fnet_ip6_frag_list
{
