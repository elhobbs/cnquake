...
typedef struct  FNET_COMP_PACKED_STRUCT fnet_nd6_ns_header
{
...
***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct  FNET_COMP_PACKED_STRUCT fnet_nd6_na_header
{
    fnet_icmp6_header_t icmp6_header    FNET_COMP_PACKED; 
...
***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct FNET_COMP_PACKED_STRUCT fnet_nd6_rd_header
{
    fnet_icmp6_header_t icmp6_header        FNET_COMP_PACKED; 
    unsigned char       _reserved[4]        FNET_COMP_PACKED;
    fnet_ip6_addr_t     target_addr         FNET_COMP_PACKED;  
...
***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct FNET_COMP_PACKED_STRUCT fnet_nd6_rs_header
{
    fnet_icmp6_header_t icmp6_header    FNET_COMP_PACKED;  
    unsigned char       _reserved[4]    FNET_COMP_PACKED;
...
***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct FNET_COMP_PACKED_STRUCT fnet_nd6_ra_header
{
 ...
 ***********************************************************************/
FNET_COMP_PACKED_BEGIN
typedef struct FNET_COMP_PACKED_STRUCT fnet_nd6_option_header
{
 ...
 ***********************************************************************/
FNET_COMP_PACKED_BEGIN 
typedef struct FNET_COMP_PACKED_STRUCT fnet_nd6_option_lla_header
{
 ...
 ***********************************************************************/
FNET_COMP_PACKED_BEGIN  
typedef struct FNET_COMP_PACKED_STRUCT fnet_nd6_option_mtu_header
{
    fnet_nd6_option_header_t    option_header   FNET_COMP_PACKED;   /* Option general header.*/
 ...
 ***********************************************************************/
FNET_COMP_PACKED_BEGIN  
typedef struct FNET_COMP_PACKED_STRUCT fnet_nd6_option_prefix_header
{
    fnet_nd6_option_header_t    option_header   FNET_COMP_PACKED;   /* Option general header.*/
